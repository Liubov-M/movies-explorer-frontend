    ...
    <section className='aboutMe'>
      ...
      <div className='aboutMe__container'>
        <div className='aboutMe__content'>
          <h3 className='aboutMe__name subtitle-text subtitle-text_size_m'>Виталий</h3>
          <p className='aboutMe__speciality'>Фронтенд-разработчик, 30 лет</p>
          <p className='aboutMe__description section-text'>Я родился и живу в Саратове, закончил факультет экономики СГУ. У меня есть жена и&nbsp;дочь.
